...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Read in dognames from file, 1 name per line & automatically closes file
    with open(dogfile, "r") as infile:
        # Read in dognames from first line in file
        line = infile.readline()

        # Process each line in file until reaching EOF (end-of-file)
        while line != "":
            ...
            # Read in next line in file to be processed
            line = infile.readline()
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            # Classifier Label IS also image of Dog (found in dognames_dic)
