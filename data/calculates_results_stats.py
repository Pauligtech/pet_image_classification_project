...
def calculates_results_stats(results_dic):
    ...
    # Calculate run statistics (counts & percentages)
    ...
    # Calculate % correct dogs (with division by zero protection)
    ...
    # Calculate % correct breed of dog (with division by zero protection)
    if results_stats_dic['n_dogs_img'] > 0:
    ...
    # Calculate % correct not-a-dog images (with division by zero protection)
    ...
    # Return the completed results_stats_dic dictionary
